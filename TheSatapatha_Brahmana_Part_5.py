...
import re
import numpy as np
base_url="https://www.sacred-texts.com/hin/sbr/sbe44/sbe44"
...
#  Spliitng the text into two list of numbers and hymns 
        ...
        with open("The_Satapatha_Brahmana_Part_5_Khanda_11.tsv", "w", encoding='utf-8') as outfile:
...
#             numbers.insert(0,"Preface")
        ...
        for adh_n,brah_n,text_n,sloka_n in zip(adhyaya,brahmana,text_no,hymn):
            result+=adh_n+"\t"+brah_n+"\t"+text_n+"\t"+sloka_n+"\n"
        with open("The_Satapatha_Brahmana_Part_5_Khanda_12.tsv", "w", encoding='utf-8') as outfile:
            outfile.write(result)
...
def thirteenth_kanda(start,end):
...
#             numbers.insert(0,"Preface")
        ...
        for adh_n,brah_n,text_n,sloka_n in zip(adhyaya,brahmana,text_no,hymn):
            result+=adh_n+"\t"+brah_n+"\t"+text_n+"\t"+sloka_n+"\n"
        with open("The_Satapatha_Brahmana_Part_5_Khanda_13.tsv", "w", encoding='utf-8') as outfile:
            outfile.write(result)
...
def fourteenth_kanda(start,end):
...
#             numbers.insert(0,"Preface")
        ...
        for adh_n,brah_n,text_n,sloka_n in zip(adhyaya,brahmana,text_no,hymn):
            result+=adh_n+"\t"+brah_n+"\t"+text_n+"\t"+sloka_n+"\n"
        with open("The_Satapatha_Brahmana_Part_5_Khanda_14.tsv", "w", encoding='utf-8') as outfile:
            outfile.write(result)
...
start_ele=3
end_ele=45
eleventh_kanda(start_ele,end_ele)
start_twe=45
end_twe=74
twelfth_kanda(start_twe,end_twe)
start_thir=74
end_thir=117
thirteenth_kanda(start_thir,end_thir)
start_four=117
end_four=125
fourteenth_kanda(start_four,end_four)

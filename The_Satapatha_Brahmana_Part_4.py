...
import re
import numpy as np
base_url="https://www.sacred-texts.com/hin/sbr/sbe43/sbe43"
...
#  Spliitng the text into two list of numbers and hymns 
        ...
        with open("The_Satapatha_Brahmana_Part_4_Khanda_8.tsv", "w", encoding='utf-8') as outfile:
...
# Adhyaya 1 brahmana 1 dropped due to so much other text
def ninth_kanda(start,end):
...
#             numbers.insert(0,"Preface")
        ...
        for adh_n,brah_n,text_n,sloka_n in zip(adhyaya,brahmana,text_no,hymn):
            result+=adh_n+"\t"+brah_n+"\t"+text_n+"\t"+sloka_n+"\n"
        with open("The_Satapatha_Brahmana_Part_4_Khanda_9.tsv", "w", encoding='utf-8') as outfile:
            outfile.write(result)
...
#             numbers.insert(0,"Preface")
        ...
        for adh_n,brah_n,text_n,sloka_n in zip(adhyaya,brahmana,text_no,hymn):
            result+=adh_n+"\t"+brah_n+"\t"+text_n+"\t"+sloka_n+"\n"
        with open("The_Satapatha_Brahmana_Part_4_Khanda_10.tsv", "w", encoding='utf-8') as outfile:
            outfile.write(result)
...
start_eight=3
end_eight=30
eighth_kanda(start_eight,end_eight)
start_nine=30
end_nine=45
ninth_kanda(start_nine,end_nine)
start_ten=45
end_ten=76
tenth_kanda(start_ten,end_ten)

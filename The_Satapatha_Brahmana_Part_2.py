...
import re
import numpy as np
base_url="https://www.sacred-texts.com/hin/sbr/sbe26/sbe26"
...
#  Spliitng the text into two list of numbers and hymns 
        ...
        with open("The_Satapatha_Brahmana_Part_2_Khanda_3.tsv", "w", encoding='utf-8') as outfile:
...
#             numbers.insert(0,"Preface")
        ...
        for adh_n,brah_n,text_n,sloka_n in zip(adhyaya,brahmana,text_no,hymn):
            result+=adh_n+"\t"+brah_n+"\t"+text_n+"\t"+sloka_n+"\n"
        with open("The_Satapatha_Brahmana_Part_2_Khanda_4.tsv", "w", encoding='utf-8') as outfile:
            outfile.write(result)
...
start_first=3
end_first=40
third_kanda(start_first,end_first)
start_sec=40
end_sec=79
fourth_kanda(start_sec,end_sec)

...
import re
import numpy as np
base_url="https://www.sacred-texts.com/hin/sbr/sbe41/sbe41"
...
#  Spliitng the text into two list of numbers and hymns 
        ...
        with open("The_Satapatha_Brahmana_Part_3_Khanda_5.tsv", "w", encoding='utf-8') as outfile:
...
#             numbers.insert(0,"Preface")
        ...
        for adh_n,brah_n,text_n,sloka_n in zip(adhyaya,brahmana,text_no,hymn):
            result+=adh_n+"\t"+brah_n+"\t"+text_n+"\t"+sloka_n+"\n"
        with open("The_Satapatha_Brahmana_Part_3_Khanda_6.tsv", "w", encoding='utf-8') as outfile:
            outfile.write(result)
...
#             numbers.insert(0,"Preface")
        ...
        for adh_n,brah_n,text_n,sloka_n in zip(adhyaya,brahmana,text_no,hymn):
            result+=adh_n+"\t"+brah_n+"\t"+text_n+"\t"+sloka_n+"\n"
        with open("The_Satapatha_Brahmana_Part_3_Khanda_7.tsv", "w", encoding='utf-8') as outfile:
            outfile.write(result)
...
start_fifth=3
end_fifth=28
fifth_kanda(start_fifth,end_fifth)
start_six=28
end_six=55
sixth_kanda(start_six,end_six)
start_sev=55
end_sev=67
seventh_kanda(start_sev,end_sev)
